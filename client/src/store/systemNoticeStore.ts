...
import { systemNoticeDtoSchema, type SystemNoticeDto } from '@marshrutizator/shared';

// The notice contract lives in @marshrutizator/shared (single source of truth, shared
