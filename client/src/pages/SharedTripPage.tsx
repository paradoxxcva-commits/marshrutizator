      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '20px 16px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '40px 0 20px' }}>
          <div className="bg-surface-card border border-edge-faint" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '8px 16px', borderRadius: 20, boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            <img src="/icons/icon.svg" alt="Маршрутизатор" width="18" height="18" style={{ borderRadius: 4 }} />
            <span className="text-[#9ca3af]" style={{ fontSize: 11 }}>{t('shared.sharedVia')} <strong className="text-[#6b7280]">Маршрутизатор</strong></span>
          </div>
          <div className="text-[#d1d5db]" style={{ marginTop: 8, fontSize: 10 }}>Создано с любовью · <a href="https://github.com/marshrutizator" className="text-[#9ca3af]" style={{ textDecoration: 'none' }}>GitHub</a></div>
        </div>
      </div>
    </div>
  )
