...
const ru: NotificationLocale = {
  ...
  welcome: {
    subject: 'Добро пожаловать в Маршрутизатор!',
    greeting: 'Здравствуйте!',
    body: 'Спасибо, что зарегистрировались в Маршрутизаторе \u2014 вашем личном помощнике по созданию идеальных путешествий.\n\nВаш аккаунт полностью готов к работе. Теперь вы можете:',
    features: [
      'Находить интересные места на интерактивной карте.',
      'Строить удобные маршруты для будущих поездок.',
      'Вести чек-листы вещей и контролировать бюджет.',
    ],
    ctaIntro: 'Никаких дополнительных подтверждений не требуется. Просто перейдите на сайт, авторизуйтесь и создайте свой первый маршрут!',
    signoff: 'Счастливого пути,\nКоманда проекта «Маршрутизатор»',
  },
};
