...
const admin: TranslationStrings = {
  ...
  'admin.addons.catalog.vacay.name': 'Календарь',
  'admin.addons.catalog.vacay.description': 'Планировщик отпускных и выходных дней',
  'admin.addons.catalog.atlas.name': 'Атлас',
  ...
  'admin.update.dataInfo':
    'Все ваши данные (поездки, пользователи, API-ключи, загрузки, Календарь, Атлас, бюджеты) будут сохранены.',
